...
public class NoInterestTermsFoundException extends Exception {
    ...
    public NoInterestTermsFoundException(final Interest interest, final String lanugage) {
        super(String.format("no terms were found for interest id:%d in language '%s'", interest.getId(), lanugage));
    }
